import 'dart:convert';
import 'package:product/DaftarAlamat/EditAlamat.dart';
// import 'package:dinamika/PROFILE/profile.dart';
import 'package:http/http.dart' as http;
import 'package:product/DaftarAlamat/TambahAlamat.dart';
...
class _DaftarAlamatState extends State<DaftarAlamat> {
  ...
  getDataAlamat() async {
    ...
    var response = await http.get(
        Uri.parse(Uri.encodeFull(
            'https://carinih.ws/api/user_account/customer_address/$pengenalid')),
  ...
  Future<String> getDataProfile() async {
    ...
    var response = await http.get(
        Uri.parse(Uri.encodeFull(
            "https://carinih.ws/api/user_account/general/$idprofile")),
        headers: {"Accept": "application/json"});
    print(response.body);
    //
    setState(() {
                    ...
                    children: [
                          ...
                          child: Center(
                            child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  style: TextStyle(
                                      fontSize: 15.sp, fontFamily: 'Comfortaa'),
                                )),
                          ),
                        ),
                      ),
                      ...
                      '$data1' == null
                          ? Padding(
                              ...
                              child: Text(
                                'Daftar alamat kamu saat ini masih kosong. Isi yuk supaya kurir bisa anter barang kamu.',
                                style: TextStyle(
                          ...
                          child: Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding:
                                      EdgeInsets.only(top: 15.h, left: 14.w),
                                ),
                                style: TextStyle(
                                    fontSize: 13.sp, fontFamily: 'Comfortaa'),
                              )),
                        ),
                      ),
                      //
                                                                ...
                                                                new FlatButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    var response = await http.delete(
                                                                        Uri.parse(
                                                                            Uri.encodeFull("https://carinih.ws/api/user_account/delete_customerAddress/$dataid")),
                                                                        headers: {
                                                                          "Accept":
                                                                              "application/json"
                                                                        });
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                              builder: (BuildContext context) => EditAlamat(
                                                                  prov: data1[i][
                                                                      'provinsi'],
                                                                  kota: data1[i]
                                                                      ['kota'],
