    ...
    http.post(Uri.parse(Uri.encodeFull(myUrl)), headers: {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => DaftarAlamat()),
          ...
          children: [
            ...
            Container(
                ...
                child: TextFormField(
                  ...
                  style: TextStyle(fontSize: 13.sp, fontFamily: 'Comfortaa'),
                )),
            //
            SizedBox(height: 10.h),
            //
            ...
            widget.asprimary.contains('Yes')
                ? SwitchListTile(
                    ...
                    title: new Text('Dijadikan ALamat Utama',
                        style: TextStyle(
                            fontFamily: 'Comfortaa',
                            fontWeight: FontWeight.w900,
                            color: Colors.deepPurple[400],
